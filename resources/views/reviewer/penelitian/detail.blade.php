    ...
    <section class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row mb-2 content-header">
                <div class="col-sm-12">
                    <h1>Detail Usulan Penelitian</h1>
                </div>
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <a href="{{route('reviewer_penelitian')}}" class="btn btn-danger"><i class="fas fa-arrow-left"></i> Kembali</a>
                        <a href="{{route('reviewer_penelitian_nilai', $id)}}" class="btn btn-success ml-auto float-right"><i class="fas fa-pencil-alt"></i> Nilai Usulan</a>
                                ...
                                <div class="card card-dark m-2 card-outline">
                                    ...
                                    <div class="card-body">
                                        <div class="m-3">
                                            ...
                                            <h6>File RAB : @if($mitra_file){{$mitra_file->mitra_sasaran_file_original_name}}@else{{"-"}}@endif</h6>
                                            ...
                                            @if($mitra_file)
                                            <a href="{{route('file_preview', [$id, $mitra_file->mitra_sasaran_file_hash_name, 'mitra'])}}" class="ml-1 btn btn-sm btn-primary" target="__blank"><i class="fas fa-eye"></i> {{__('id.preview')}}</a>
                                            <a href="{{route('file_download', [$id, $mitra_file->mitra_sasaran_file_hash_name, 'mitra'])}}" class="ml-1 btn btn-sm btn-success"><i class="fas fa-cloud-download-alt"></i> {{__('id.download')}}</a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
