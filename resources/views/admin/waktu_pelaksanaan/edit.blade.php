...
@section('title', 'Waktu Pelaksanaan Kegiatan')
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('admin_waktu_pelaksanaan_update', $waktu['id'])}}" method="POST">
                            @csrf
                            @method('patch')
                            <div class="card-body">
                                <input type="hidden" value="{{$waktu['label']}}" name="label" id="label">
                                <input type="hidden" value="{{$waktu['name']}}" name="name" id="name">
                                <div class="row">
                                    <div class="col-md-3">
