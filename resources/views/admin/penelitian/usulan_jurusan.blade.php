                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <ul class="nav nav-pills">
                            <li class="nav-item"><a class="nav-link @if(Request::segment(4) == NULL){{'active'}}@endif m-1" href="{{route('admin_penelitian_usulan')}}">Semua</a></li>
                            @foreach($jurusan as $row)
                            <li class="nav-item"><a class="nav-link m-1 @if($row->jurusan_nama == $current_jurusan){{'active'}}@endif" href="{{route('admin_penelitian_usulan_jurusan', $row->jurusan_id)}}">{{$row->jurusan_nama}}</a></li>
                            @endforeach
                        </ul>
                    </div>
