                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <ul class="nav nav-pills">
                            <li class="nav-item"><a class="nav-link active m-1" href="{{route('admin_penelitian_riwayat')}}">Semua</a></li>
                            @foreach($jurusan as $row)
                            <li class="nav-item"><a class="nav-link m-1" href="{{route('admin_penelitian_riwayat_jurusan', $row->jurusan_id)}}">{{$row->jurusan_nama}}</a></li>
                            @endforeach
                        </ul>
                    </div>
                                ...
                                <table id="example2" class="table table-bordered table-hover table-striped projects">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="card-body">
                                                    <a class="btn btn-success btn-sm" href="{{route('admin_penelitian_detail', [$usulan->usulan_penelitian_id, 'riwayat'])}}">
