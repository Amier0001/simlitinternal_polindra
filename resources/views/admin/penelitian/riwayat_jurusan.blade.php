                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <ul class="nav nav-pills">
                            <li class="nav-item"><a class="nav-link @if(Request::segment(4) == NULL){{'active'}}@endif m-1" href="{{route('admin_penelitian_riwayat')}}">Semua</a></li>
                            @foreach($jurusan as $row)
                            <li class="nav-item"><a class="nav-link m-1 @if($row->jurusan_nama == $current_jurusan){{'active'}}@endif" href="{{route('admin_penelitian_riwayat_jurusan', $row->jurusan_id)}}">{{$row->jurusan_nama}}</a></li>
                            @endforeach
                        </ul>
                    </div>
                                ...
                                <table id="example2" class="table table-bordered table-hover table-striped projects">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {{$usulan->usulan_penelitian_tahun}}
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="card-body">
                                                    <a class="btn btn-success btn-sm" href="{{route('admin_penelitian_detail', [$usulan->usulan_penelitian_id, 'usulan'])}}">
                                                    ...
                                                    <a class="btn btn-primary btn-sm" href="{{route('admin_penelitian_usulan_konfirmasi', $usulan->usulan_penelitian_id)}}">
                                                 ...
                                                 @if($usulan->usulan_penelitian_status == "diterima")
                                                <a class="btn btn-info btn-sm" href="{{route('admin_penelitian_unlock', $usulan->usulan_penelitian_id)}}">
