...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="{{url('pengusul/dashboard')}}" class="brand-link">
                <img src="{{URL::asset('assets/img/logo/polindra.png')}}" alt="" class="brand-image img-circle elevation-3" style="opacity: 1;">
                <span class="brand-text font-weight-light">Dashboard Pengusul</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column pb-5" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="{{route('pengusul_dashboard')}}" class="nav-link @if(Request::segment(1) == 'dashboard' || Request::segment(2) == 'dashboard') {{'active'}} @endif">
                        ...
                        <li class="nav-item @if(Request::segment(2) == 'penelitian'){{'menu-is-opening menu-open'}} @endif">
                            <a href="#" class="nav-link @if(Request::segment(2) == 'penelitian') {{'active'}} @endif">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{route('pengusul_penelitian')}}" class="nav-link @if(Request::segment(2) == 'penelitian' && Request::segment(3) != 'riwayat'&& Request::segment(3) != 'detail') {{'active'}} @endif">
                                ...
                                <li class="nav-item">
                                    <a href="{{route('pengusul_penelitian_riwayat')}}" class="nav-link @if(Request::segment(2) == 'penelitian' && Request::segment(3) == 'riwayat' && Request::segment(4) == NULL) {{'active'}} @endif">
                                        <i class="nav-icon fas fa-angle-right"></i>
                                        <p>
                                            Riwayat Penelitian
                                        </p>
