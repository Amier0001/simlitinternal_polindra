            ...
            <div class="container-fluid">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Substansi usulan penelitian Kepada Masyarakat</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <div class="card-body p-0">
                        <div class="bs-stepper">
                            ...
                            <form action="{{route('pengusul_penelitian_upload_dokumen', $id)}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row m-4">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label for="dokumen_usulan"><i class="fas fa-file-alt fa-2x"></i> Dokumen Usulan (PDF/Word, Maks 10MB)</label>
                                            ...
                                            @if($dokumen_info)
                                            <!-- <a href="{{route('pengusul_penelitian_file_preview', [$id, $dokumen_info->dokumen_usulan_hash_name, 'usulan'])}}" class="ml-1 btn btn-sm btn-primary" target="__blank"><i class="fas fa-eye"></i> Preview</a>
                                            <a href="{{route('pengusul_penelitian_file_download', [$id, $dokumen_info->dokumen_usulan_hash_name, 'usulan'])}}" class="ml-1 btn btn-sm btn-success"><i class="fas fa-cloud-download-alt"></i> Download</a> -->
                                            <a href="{{route('file_preview', [$id, $dokumen_info->dokumen_usulan_hash_name, 'usulan'])}}" class="ml-1 btn btn-sm btn-primary" target="__blank"><i class="fas fa-eye"></i> Preview</a>
                                            <a href="{{route('file_download', [$id, $dokumen_info->dokumen_usulan_hash_name, 'usulan'])}}" class="ml-1 btn btn-sm btn-success"><i class="fas fa-cloud-download-alt"></i> Download</a>
                                            <br>
                                            <br>
                                            @endif
                                            ...
                                            <div class="input-group  @error('dokumen_usulan') is-invalid @enderror">
                                                <div class="custom-file">
                                                    ...
                                                    <label class="custom-file-label" for="dokumen_usulan">Unggah File</label>
                                                </div>
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{route('pengusul_penelitian_usulan', [$page+1, $id])}}" class="btn btn-primary ml-auto float-right"><i class="fas fa-arrow-right"></i> Lanjut</a>
                        </div>
                    </div>
                    <!-- /.card-body -->
                </div>
