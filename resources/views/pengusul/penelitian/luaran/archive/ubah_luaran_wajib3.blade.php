                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 @error('kategori') is-invalid @enderror" style="width: 100%;" name="kategori">
                                            <option value="Video pelaksanaan kegiatan" selected>Video pelaksanaan kegiatan</option>
                                        </select>
                                        @error('kategori')
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 @error('jenis') is-invalid @enderror" style="width: 100%;" name="jenis">
                                            <option value="Konten Video pelaksanaan kegiatan" selected>Konten Video pelaksanaan kegiatan</option>
                                        </select>
                                        @error('jenis')
                                        <div class="invalid-feedback">
                                            Pilih Jenis Luaran
                                    ...
                                    <div class="form-group">
                                        <label for="rencana">Rencana situs publikasi video kegiatan</label>
                                        <input type="text" class="form-control @error('rencana') is-invalid @enderror" id="rencana" name="rencana" placeholder="Rencana situs publikasi video kegiatan" value="{{$luaran->usulan_luaran_penelitian_rencana}}">
                                        @error('rencana')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 @error('status') is-invalid @enderror" style="width: 100%;" name="status">
                                            <option value="Bisa Diakses" selected>Bisa Diakses</option>
                                        </select>
                                        @error('status')
                                        <div class="invalid-feedback">
                                            Pilih Status
