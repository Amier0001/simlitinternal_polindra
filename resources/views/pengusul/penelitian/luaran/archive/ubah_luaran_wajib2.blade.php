                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body p-0">
                        <div class="bs-stepper">
                            ...
                            <!-- CONTENT -->
                            <form action="{{route('pengusul_penelitian_update_luaran', [$id, $luaran->usulan_luaran_id])}}" method="POST">
                                @csrf
                                @method('patch')
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 @error('kategori') is-invalid @enderror" style="width: 100%;" name="kategori">
                                            <option value="Publikasi di media massa cetak" selected>Publikasi di media massa cetak</option>
                                            <option value="Publikasi di media massa elektronik">Publikasi di media massa elektronik</option>
                                        </select>
                                        @error('kategori')
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 @error('jenis') is-invalid @enderror" style="width: 100%;" name="jenis">
                                            <option value="Artikel di media massa cetak" selected>Artikel di media massa cetak</option>
                                            <option value="Artikel di media massa elektronik">Artikel di media massa elektronik</option>
                                        </select>
                                        @error('jenis')
                                        <div class="invalid-feedback">
                                            Pilih Jenis Luaran
                                    ...
                                    <div class="form-group">
                                        <label for="rencana">Rencana nama Media Massa</label>
                                        <input type="text" class="form-control @error('rencana') is-invalid @enderror" id="rencana" name="rencana" placeholder="Rencana Capaian Peningkatan" value="{{$luaran->usulan_luaran_penelitian_rencana}}">
                                        @error('rencana')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
