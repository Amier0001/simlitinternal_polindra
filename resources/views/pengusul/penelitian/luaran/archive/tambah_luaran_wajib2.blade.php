                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body p-0">
                        <div class="bs-stepper">
                            ...
                            <!-- CONTENT -->
                            <form action="{{route('pengusul_penelitian_store_luaran', [$id, 'wajib', 2])}}" method="POST">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('rencana') is-invalid @enderror" id="rencana" name="rencana" placeholder="Rencana Capaian Peningkatan" value="{{old('rencana')}}">
                                        @error('rencana')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
