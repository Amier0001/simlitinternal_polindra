                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body p-0">
                        <div class="bs-stepper">
                            ...
                            <!-- CONTENT -->
                            <form action="{{route('pengusul_penelitian_store_luaran', [$id, $tipe])}}" method="POST">
                                @csrf
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 @error('tahun') is-invalid @enderror" style="width: 100%;" name="tahun">
                                            @for($i = 1; $i <= intval($lama_kegiatan->usulan_penelitian_lama_kegiatan); $i++)
                                             <!-- -->
...
<script>
    $(function() {
        ...
        $.ajax({
            url: "{{route('pengusul_penelitian_luaran_get_jenis')}}",
            method: "POST",
            data: {
        ...
        $.ajax({
            url: "{{route('pengusul_penelitian_luaran_get_status')}}",
            method: "POST",
            data: {
                id_kategori: kategori_id,
                id_status: status_id
