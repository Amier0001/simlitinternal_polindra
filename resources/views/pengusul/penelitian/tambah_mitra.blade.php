            ...
            <div class="container-fluid">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Tambah Mitra Sasaran</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <div class="card-body p-0">
                        <div class="bs-stepper">
                            ...
                            <!-- CONTENT -->
                            <form action="{{route('pengusul_penelitian_store_tambah_mitra', $id)}}" method="POST">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 @error('tipe_mitra') is-invalid @enderror" style="width: 100%;" name="tipe_mitra">
                                            ...
                                            <option value="lembaga_pemerintahan" @if(old('tipe_mitra')=="lembaga_pemerintahan" ){{'selected'}}@endif>Lembaga Pemerintahan</option>
                                            <option value="Lembaga_pendidikan_tinggi_maupun_swasta" @if(old('tipe_mitra')=="Lembaga_pendidikan_tinggi_maupun_swasta" ){{'selected'}}@endif>Lembaga Pendidikan Tinggi Maupun Swasta</option>
                                            <option value="alumni_politeknik_negeri_indramayu" @if(old('tipe_mitra')=="alumni_politeknik_negeri_indramayu" ){{'selected'}}@endif>Alumni Politeknik Negeri Indramayu</option>
                                    ...
                                    <div class="card-footer">
                                        <a href="{{route('pengusul_penelitian_usulan', [6, $id])}}" class="btn btn-danger"><i class="fas fa-times"></i> Batal</a>
...
<script>
    $(function() {
        ...
        $.ajax({
            url: "{{route('pengusul_penelitian_get_kabupaten')}}",
            method: "POST",
            data: {
...
<script>
    $(function() {
        ...
        $.ajax({
            url: "{{route('pengusul_penelitian_get_kecamatan')}}",
            method: "POST",
            data: {
                id_kabupaten: kabupaten_id,
...
<script>
    $(function() {
        ...
        $.ajax({
            url: "{{route('pengusul_penelitian_get_desa')}}",
            method: "POST",
            data: {
                id_kecamatan: kecamatan_id,
                id_desa: desa_id
