                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-11">
                                                                ...
                                                                <br>
                                                                <a href="{{route('file_preview', [$laporan_kemajuan->laporan_kemajuan_id, $laporan_kemajuan->laporan_kemajuan_hash_name,'laporan_kemajuan'])}}" class="ml-1 btn btn-xs btn-primary" target="__blank"><i class="fas fa-eye"></i> Preview</a>
                                                                <a href="{{route('file_download', [$laporan_kemajuan->laporan_kemajuan_id, $laporan_kemajuan->laporan_kemajuan_hash_name,'laporan_kemajuan'])}}" class="ml-1 btn btn-xs btn-success"><i class="fas fa-cloud-download-alt"></i> Download</a>
                                                            </div>
                                                        </div>
                                                        @else
                                                        <div class="row">
                                                    ...
                                                    <td>
                                                        <a class="btn btn-primary btn-sm" href="{{route('pengusul_laporan_kemajuan_insert', [$penelitian_id, ($laporan_kemajuan) ? $laporan_kemajuan->laporan_kemajuan_id : 0, 'kemajuan'])}}">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-11">
                                                                ...
                                                                <br>
                                                                <a href="{{route('file_preview', [$laporan_keuangan->laporan_kemajuan_id, $laporan_keuangan->laporan_kemajuan_hash_name,'laporan_kemajuan'])}}" class="ml-1 btn btn-xs btn-primary" target="__blank"><i class="fas fa-eye"></i> Preview'</a>
                                                                <a href="{{route('file_download', [$laporan_keuangan->laporan_kemajuan_id, $laporan_keuangan->laporan_kemajuan_hash_name,'laporan_kemajuan'])}}" class="ml-1 btn btn-xs btn-success"><i class="fas fa-cloud-download-alt"></i> Download'</a>
                                                            </div>
                                                        </div>
                                                        @else
                                                        <div class="row">
                                                    ...
                                                    <td>
                                                        <a class="btn btn-primary btn-sm" href="{{route('pengusul_laporan_kemajuan_insert', [$penelitian_id, ($laporan_keuangan) ? $laporan_keuangan->laporan_kemajuan_id : 0, 'keuangan'])}}">
                                                            <i class="fas fa-upload">
                                                            </i>
                                                            Upload Laporan
                                                        </a>
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-primary btn-sm" href="{{route('pengusul_laporan_kemajuan_insert', [$penelitian_id, $data->usulan_luaran_id, 'luaran'])}}">
                                                            <i class="fas fa-upload">
                                                            </i>
                                                            Upload Laporan
                                                        </a>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-11">
                                                                ...
                                                                Tanggal Unggah : {{Carbon\Carbon::parse($doc->laporan_luaran_date)->isoFormat('D MMMM Y')}}
                                                                <br>
                                                                <a href="{{route('file_preview', [$doc->laporan_luaran_id, $doc->laporan_luaran_hash_name,'laporan_luaran'])}}" class="ml-1 btn btn-xs btn-primary" target="__blank"><i class="fas fa-eye"></i> {{__('id.preview')}}</a>
                                                                <a href="{{route('file_download', [$doc->laporan_luaran_id, $doc->laporan_luaran_hash_name,'laporan_luaran'])}}" class="ml-1 btn btn-xs btn-success"><i class="fas fa-cloud-download-alt"></i> {{__('id.download')}}</a>
                                                            </div>
                                                        </div>
                                                        @else
                                                        <div class="row">
