                            ...
                            <form action="{{route('pengusul_biodata_update')}}" method="POST">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="pendidikan" type="text" class="form-control @error('pendidikan') is-invalid @enderror" id="pendidikan" placeholder="Masukan Jenjang Pendidikan" value="@if($user->biodata){{$user->biodata->biodata_pendidikan}}@endif">                                                @error('pendidikan')
                                                <div class="invalid-feedback">
                                                    {{$message}}
                                                </div>
                                                @enderror
                                    ...
                                    <div class="card-footer">
                                        <a href="{{route('pengusul_dashboard')}}" class="btn btn-danger">Batal</a>
